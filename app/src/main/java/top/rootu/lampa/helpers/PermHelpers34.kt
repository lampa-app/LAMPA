...
object PermHelpers34 {
    ...
    fun hasStoragePermissions(context: Context?): Boolean {
        ...
        if (VERSION.SDK_INT >= Build.VERSION_CODES.R) return Environment.isExternalStorageManager()
        else return hasPermissions(context, *PERMISSIONS_STORAGE)
    }
