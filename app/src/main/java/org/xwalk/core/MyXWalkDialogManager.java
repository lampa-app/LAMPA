 ...
 * import org.xwalk.core.MyXWalkDialogManager;
 ...
 *
 *         MyXWalkDialogManager dialogManager = getDialogManager();
 *         AlertDialog dialog = dialogManager.getAlertDialog(MyXWalkDialogManager.DIALOG_NOT_FOUND);
 ...
 * </pre>
 *
 * <p>And when using {@link MyXWalkUpdater}:</p>
 *
 * <pre>
 ...
 *
 *             mDialogManager = new MyXWalkDialogManager(this);
 *             mDialogManager.setAlertDialog(MyXWalkDialogManager.DIALOG_NOT_FOUND, dialog);
 *             mXWalkUpdater = new MyXWalkUpdater(this, this, mDialogManager);
 *         }
    ...
    void showInitializationError(int status, Runnable cancelCommand, Runnable downloadCommand, Runnable appStoreCommand) {
        ...
        if (status != XWalkLibraryInterface.STATUS_NEWER_VERSION
            ...
            if (downloadCommand != null && appStoreCommand != null) {
                ...
                setPositiveButton(dialog, netfix.app.R.string.xwalk_download_crosswalk);
                actions.add(new ButtonAction(DialogInterface.BUTTON_NEGATIVE, appStoreCommand, false));
                setNegativeButton(dialog, netfix.app.R.string.xwalk_market_crosswalk);
